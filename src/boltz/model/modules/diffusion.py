...
class DiffusionModule(Module):
    ...
    def forward(
        ...
        a, a_list = self.token_transformer(
            a,
            mask=mask.float(),
            s=s,
        ...
        return {"r_update": r_update, "token_a": a, "token_a_list": a_list}
...
class AtomDiffusion(Module):
    ...
    def preconditioned_network_forward(
        ...
        return denoised_coords, net_out["token_a"], net_out["token_a_list"]
    ...
    def sample(
        ...
        **network_condition_kwargs,
        ...
        for sigma_tm, sigma_t, gamma in sigmas_and_gammas:
            ...
            with torch.no_grad():
                atom_coords_denoised, token_a, token_a_list = self.preconditioned_network_forward(
                    atom_coords_noisy,
                    t_hat,
                    training=False,
                    network_condition_kwargs=dict(
        ...
        #zijun modified
        return dict(sample_atom_coords=atom_coords, diff_token_repr=token_repr, token_a_list=token_a_list)
    ...
    def forward(
        ...
        denoised_atom_coords, _ , _= self.preconditioned_network_forward(
            noised_atom_coords,
            sigmas,
            training=True,
            network_condition_kwargs=dict(
